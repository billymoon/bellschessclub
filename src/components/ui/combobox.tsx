      ...
      <InputGroupAddon align="inline-end">
        {showTrigger && (
          <InputGroupButton
            ...
            className="group-has-data-[slot=combobox-clear]/input-group:hidden data-pressed:bg-background-interactive"
            disabled={disabled}
          >
            <ComboboxTrigger />
          </InputGroupButton>
