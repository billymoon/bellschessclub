  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        />
        <FormFieldSelect label="Allegro is estimated">
          <select
            ...
            className={cn(
              ...
              "bg-background-interactive px-2 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
        ...
        />
        <FormFieldSelect label="Standard is estimated">
          <select
        ...
        <FormFieldSelect label="General availability">
          <select
            {...registerWithErrors("generalAvailability")}
            className={cn(
              "placeholder:text-muted-foreground dark:bg-input/30 border-input h-9 w-full min-w-0 rounded-md border appearance-none",
              "bg-background-interactive px-2 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
              "focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]",
